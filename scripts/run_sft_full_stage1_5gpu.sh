...
CONFIG="${1:-${PROJECT_ROOT}/configs/posttrain/smol_smoltalk_sft_full_stage1_v1.yaml}"
RUN_ROOT="${PROJECT_ROOT}/runs/posttrain/smol-smoltalk-sft-full-stage1-v1"
LOG_ROOT="${PROJECT_ROOT}/logs/posttrain"
LOG_PATH="${LOG_ROOT}/smol-smoltalk-sft-full-stage1-v1.log"
